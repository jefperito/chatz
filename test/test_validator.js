...
suite('validator', function() {
    ...
    suite('message', function() {
        ...
        test('should throws exception if message has not own property sender', function() {
            var message = {
                room_id: 1,
                body: 'Hello World!'
            };
        ...
        test('should throws exception if message has not own property room_id', function() {
            var message = {
                sender: {
                    id: 1
                },
